...
class HeuristicSearcherV14 final : public Searcher {
public:
    explicit HeuristicSearcherV14(std::size_t tt_mb = 64);
...
private:
    ...
    TTProbeOptions make_tt_probe_options(int ply, const SearchState& state) const;
