...
class NnueSearcherV44 final : public Searcher {
public:
    ...
    struct SelectiveConfig {
        // Inherited unchanged from V43 production config 98b7732c9587 so the
        // TT lifecycle remains the only experimental variable.
    ...
    // V43 production aspiration profile 906570ae8ede, inherited unchanged
    // and paired with the selective settings above.
    ...
    struct AspirationStats {
        ...
        // Retained for side-by-side V42 diagnostics.  A genuine scalar V44
    ...
    std::size_t tt_occupied_entry_count() const;
...
private:
    ...
    struct RootSearchResult {
        ...
        V44SingleBoundTranspositionTable::Bound bound =
            V44SingleBoundTranspositionTable::Bound::None;
    };
    ...
    V44SingleBoundTranspositionTable tt_;
