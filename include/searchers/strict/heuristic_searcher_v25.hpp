...
class HeuristicSearcherV25 final : public Searcher {
public:
...
private:
    ...
    Position profiled_child_position(const Position& pos, const ScoredMove& scored_move) const;
