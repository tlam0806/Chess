...
enum class V11MoveOrderingProfile {
    Baseline,
    CheckBeforeGoodCapture,
    KillerBeforeCheck,
    HistoryBeforeKiller,
    BadCaptureBeforeQuiet
};

class HeuristicSearcherV11 final : public Searcher {
public:
    explicit HeuristicSearcherV11(
        std::size_t tt_mb = 64,
        V11MoveOrderingProfile profile = V11MoveOrderingProfile::BadCaptureBeforeQuiet
    );
...
private:
    ...
    V11MoveOrderingProfile profile_ = V11MoveOrderingProfile::BadCaptureBeforeQuiet;
};
