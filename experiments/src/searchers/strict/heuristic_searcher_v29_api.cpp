...
HeuristicSearcherV29::HeuristicSearcherV29(
    std::size_t tt_mb,
...
std::string_view HeuristicSearcherV29::name() const {
    return "heuristic_v29";
}

void HeuristicSearcherV29::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV29::tt_entry_count() const {
    return tt_.entry_count();
}

void HeuristicSearcherV29::clear_tt_stats() {
    tt_.clear_stats();
}

const RangeTranspositionTableStats& HeuristicSearcherV29::tt_stats() const {
    return tt_.stats();
}
