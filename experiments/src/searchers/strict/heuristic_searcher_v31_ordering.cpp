...
#include "heuristic_searcher_v31_detail.hpp"
...
int HeuristicSearcherV31::qsearch_order_score(
...
template int HeuristicSearcherV31::qsearch_order_score<false, false>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV31::qsearch_order_score<true, false>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV31::qsearch_order_score<false, true>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV31::qsearch_order_score<true, true>(
    PieceType,
    PieceType
) const;

template <bool IsCapture, bool IsPromotion>
HeuristicSearcherV31::ScoredMove HeuristicSearcherV31::make_qsearch_scored_move(
    Move move,
    PieceType moved_piece,
    PieceType captured_piece
) const {
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_qsearch_scored_move<false, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_qsearch_scored_move<true, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_qsearch_scored_move<false, true>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_qsearch_scored_move<true, true>(
    Move,
    PieceType,
    PieceType
) const;

bool HeuristicSearcherV31::is_quiet_move(const ScoredMove& scored_move) const {
...
template <bool IsCapture, bool IsPromotion>
int HeuristicSearcherV31::main_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
template int HeuristicSearcherV31::main_order_score<false, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV31::main_order_score<true, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV31::main_order_score<false, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV31::main_order_score<true, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
HeuristicSearcherV31::ScoredMove HeuristicSearcherV31::make_scored_move(
    const Position& pos,
...
HeuristicSearcherV31::ScoredMove HeuristicSearcherV31::make_tt_lower_scored_move(
    const Position& pos,
    Move move
) const {
    const bool capture = is_capture(move);
...
template <HeuristicSearcherV31::ScoringMode Mode, bool IsCapture, bool IsPromotion>
HeuristicSearcherV31::ScoredMove HeuristicSearcherV31::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::MainSearch, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::MainSearch, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::MainSearch, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::MainSearch, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::Quiescence, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::Quiescence, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::Quiescence, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV31::ScoredMove
HeuristicSearcherV31::make_scored_legal_move<HeuristicSearcherV31::ScoringMode::Quiescence, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
bool HeuristicSearcherV31::better_scored_move(
...
void HeuristicSearcherV31::sort_scored_moves(ScoredMoveList& moves) const {
...
HeuristicSearcherV31::ScoredMoveList HeuristicSearcherV31::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
HeuristicSearcherV31::CaptureMoveLists
HeuristicSearcherV31::generate_legal_capture_scored_move_lists_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV31::ScoredMoveList HeuristicSearcherV31::ordered_priority_quiet_moves_for_stage(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
template <HeuristicSearcherV31::MoveGenerationStage Stage>
HeuristicSearcherV31::ScoredMoveList HeuristicSearcherV31::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
template HeuristicSearcherV31::ScoredMoveList
HeuristicSearcherV31::ordered_moves_for_stage<HeuristicSearcherV31::MoveGenerationStage::QuietNonPromotion>(
    const Position&,
