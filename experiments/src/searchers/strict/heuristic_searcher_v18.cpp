...
struct HeuristicSearcherV18::SearchState {
...
enum class HeuristicSearcherV18::ScoringMode {
    MainSearch,
    Quiescence
};

struct HeuristicSearcherV18::ScoredMove {
    Move move{};
    int order_score = 0;
...
struct HeuristicSearcherV18::SearchValue {
    ScoreRange range{};
};

struct HeuristicSearcherV18::TTProbeResult {
    ScoreRange range{};
    MoveRange moves{};
    bool hit = false;
...
int HeuristicSearcherV18::score_to_tt(int score, int ply) const {
...
HeuristicSearcherV18::TTProbeResult HeuristicSearcherV18::probe_tt(
    HashKey key,
    int depth,
    int& alpha,
    int& beta,
...
bool HeuristicSearcherV18::should_store_tt(ScoreRange range) const {
    return EnableTt
        && (range.lower != range.upper || EnableTtExactStore);
}

bool HeuristicSearcherV18::should_stop(SearchState& state) const {
...
int HeuristicSearcherV18::move_order_score(
    Move move,
    const Position& pos,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV18::ScoredMove HeuristicSearcherV18::make_scored_move(
    const Position& pos,
    Move move,
    int ply,
    MoveRange tt_moves,
...
bool HeuristicSearcherV18::better_scored_move(
...
std::vector<HeuristicSearcherV18::ScoredMove> HeuristicSearcherV18::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
std::vector<HeuristicSearcherV18::ScoredMove> HeuristicSearcherV18::ordered_noisy_moves(
    const Position& pos
) const {
    std::vector<ScoredMove> ordered;
    const std::vector<Move> moves = generate_legal_moves(pos);
...
HeuristicSearcherV18::SearchValue HeuristicSearcherV18::quiescence(
    Position pos,
    int alpha,
    int beta,
    int ply,
...
bool HeuristicSearcherV18::is_quiet_move(const ScoredMove& scored_move) const {
    return !scored_move.capture
        && !scored_move.promotion
        && !scored_move.gives_check;
}

HeuristicSearcherV18::SearchValue HeuristicSearcherV18::negamax(
    Position pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV18::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
SearchResult HeuristicSearcherV18::search_fixed_depth(
    const Position& pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV18::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
SearchResult HeuristicSearcherV18::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
    SearchState state;
...
SearchResult HeuristicSearcherV18::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV18::name() const {
    return "heuristic_v18";
}

void HeuristicSearcherV18::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV18::tt_entry_count() const {
    return tt_.entry_count();
}

void HeuristicSearcherV18::clear_tt_stats() {
    tt_.clear_stats();
}

const RangeTranspositionTableStats& HeuristicSearcherV18::tt_stats() const {
    return tt_.stats();
}

void HeuristicSearcherV18::clear_move_ordering_stats() {
    move_ordering_stats_ = {};
}

const HeuristicSearcherV18::MoveOrderingStats& HeuristicSearcherV18::move_ordering_stats() const {
