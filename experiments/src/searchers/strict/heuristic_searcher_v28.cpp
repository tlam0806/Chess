...
void HeuristicSearcherV28::reward_quiet_cutoff(
    Color side_to_move,
    int depth,
    int ply,
...
void HeuristicSearcherV28::penalize_failed_quiets(
    Color side_to_move,
    int depth,
    Move prev_move,
    PieceType prev_moved_piece,
    const HeuristicSearcherV28::ScoredMoveList& failed_quiet_moves
) {
...
bool HeuristicSearcherV28::should_stop(SearchState& state) const {
...
KingSafetyContext HeuristicSearcherV28::current_king_safety_context(const Position& pos) const {
    return cached_king_safety_context(pos, pos.side_to_move);
}

int HeuristicSearcherV28::evaluate_current_position(const Position& pos) const {
    return evaluate_for_side_to_move(pos);
}



HeuristicSearcherV28::SearchValue HeuristicSearcherV28::quiescence(
    Position& pos,
    int alpha,
    int beta,
    int ply,
...
HeuristicSearcherV28::SearchValue HeuristicSearcherV28::negamax(
    Position& pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV28::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
HeuristicSearcherV28::RootSearchResult HeuristicSearcherV28::search_fixed_depth(
    Position pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV28::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
SearchResult HeuristicSearcherV28::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
    SearchState state;
    return search_fixed_depth(pos, depth, state).result;
}

SearchResult HeuristicSearcherV28::search_best_move(const Position& pos, const SearchLimits& limits) {
