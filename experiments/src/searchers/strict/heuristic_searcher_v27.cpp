...
struct HeuristicSearcherV27::SearchState {
...
enum class HeuristicSearcherV27::ScoringMode {
    MainSearch,
    Quiescence
};

enum class HeuristicSearcherV27::MoveGenerationStage {
    Priority,
    QuietNonPromotion
};

struct HeuristicSearcherV27::SearchValue {
    ScoreRange range{};
};

struct HeuristicSearcherV27::RootSearchResult {
    SearchResult result{};
    ScoreRange range{};
};

struct HeuristicSearcherV27::TTProbeResult {
    ScoreRange range{};
    MoveRange moves{};
    bool hit = false;
...
int HeuristicSearcherV27::score_to_tt(int score, int ply) const {
...
HeuristicSearcherV27::TTProbeResult HeuristicSearcherV27::probe_tt(
    HashKey key,
    int depth,
    int& alpha,
    int& beta,
...
bool HeuristicSearcherV27::should_store_tt(ScoreRange range) const {
    return EnableTt
        && (range.lower != range.upper || EnableTtExactStore);
}

void HeuristicSearcherV27::update_best_range(
...
void HeuristicSearcherV27::store_tt_if_needed(
    HashKey key,
    int depth,
    int ply,
    ScoreRange range,
...
void HeuristicSearcherV27::reward_quiet_cutoff(
    Color side_to_move,
    int depth,
    int ply,
...
void HeuristicSearcherV27::penalize_failed_quiets(
    Color side_to_move,
    int depth,
    Move prev_move,
    PieceType prev_moved_piece,
    const HeuristicSearcherV27::ScoredMoveList& failed_quiet_moves
) {
...
bool HeuristicSearcherV27::should_stop(SearchState& state) const {
...
KingSafetyContext HeuristicSearcherV27::profiled_king_safety_context(const Position& pos) const {
    ProfileTimer timer(
        timing_stats_enabled_,
...
int HeuristicSearcherV27::profiled_evaluate_for_side_to_move(const Position& pos) const {
    ProfileTimer timer(
        timing_stats_enabled_,
...
void HeuristicSearcherV27::profiled_make_move(
    Position& pos,
    const ScoredMove& scored_move,
    UndoState& undo
) const {
...
void HeuristicSearcherV27::profiled_unmake_move(
    Position& pos,
    Move move,
...
int HeuristicSearcherV27::move_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
HeuristicSearcherV27::ScoredMove HeuristicSearcherV27::make_scored_move(
    const Position& pos,
...
HeuristicSearcherV27::ScoredMove HeuristicSearcherV27::make_scored_move_by_attack_check(
    const Position& pos,
    Move move,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV27::ScoredMove HeuristicSearcherV27::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
bool HeuristicSearcherV27::better_scored_move(
...
void HeuristicSearcherV27::sort_scored_moves(ScoredMoveList& moves) const {
    ProfileTimer timer(
        timing_stats_enabled_,
...
HeuristicSearcherV27::ScoredMoveList HeuristicSearcherV27::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
Move HeuristicSearcherV27::valid_priority_killer(const Position& pos, int ply, int slot) const {
...
HeuristicSearcherV27::ScoredMoveList
HeuristicSearcherV27::generate_legal_noisy_scored_moves_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV27::ScoredMoveList HeuristicSearcherV27::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV27::SearchValue HeuristicSearcherV27::quiescence(
    Position& pos,
    int alpha,
    int beta,
    int ply,
    ...
    if (side_in_check) {
        ...
        for (std::size_t move_index = 0; move_index < moves.size(); ++move_index) {
            ...
            ScoreRange move_range;
            {
                MoveUndoGuard move_guard(pos, scored_move.move, scored_move.moved_piece, scored_move.captured_piece);
...
bool HeuristicSearcherV27::is_quiet_move(const ScoredMove& scored_move) const {
    return !scored_move.capture
        && !scored_move.promotion
        && !scored_move.gives_check;
}

void HeuristicSearcherV27::add_move_type_stats(
    MoveTypeStats& stats,
...
void HeuristicSearcherV27::record_node_with_moves(ScoringMode stage) {
    if (!move_ordering_stats_enabled_) {
        return;
    }
...
void HeuristicSearcherV27::record_beta_cutoff(
    const HeuristicSearcherV27::ScoredMoveList& moves,
...
void HeuristicSearcherV27::record_generated_stage_move(
    const ScoredMove& move,
    Color side_to_move,
    int ply,
    MoveRange tt_moves,
...
void HeuristicSearcherV27::record_priority_stage_top_moves(
    const HeuristicSearcherV27::ScoredMoveList& moves,
    Color side_to_move,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV27::SearchValue HeuristicSearcherV27::negamax(
    Position& pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV27::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
HeuristicSearcherV27::RootSearchResult HeuristicSearcherV27::search_fixed_depth(
    Position pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV27::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
SearchResult HeuristicSearcherV27::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
    SearchState state;
    return search_fixed_depth(pos, depth, state).result;
}

SearchResult HeuristicSearcherV27::search_best_move(const Position& pos, const SearchLimits& limits) {
