...
int HeuristicSearcherV33::qsearch_order_score(
...
template int HeuristicSearcherV33::qsearch_order_score<false, false>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV33::qsearch_order_score<true, false>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV33::qsearch_order_score<false, true>(
    PieceType,
    PieceType
) const;

template int HeuristicSearcherV33::qsearch_order_score<true, true>(
    PieceType,
    PieceType
) const;

template <bool IsCapture, bool IsPromotion>
HeuristicSearcherV33::ScoredMove HeuristicSearcherV33::make_qsearch_scored_move(
    Move move,
    PieceType moved_piece,
    PieceType captured_piece
) const {
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_qsearch_scored_move<false, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_qsearch_scored_move<true, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_qsearch_scored_move<false, true>(
    Move,
    PieceType,
    PieceType
) const;
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_qsearch_scored_move<true, true>(
    Move,
    PieceType,
    PieceType
) const;

bool HeuristicSearcherV33::is_quiet_move(const ScoredMove& scored_move) const {
...
template <bool IsCapture, bool IsPromotion>
int HeuristicSearcherV33::main_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
template int HeuristicSearcherV33::main_order_score<false, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV33::main_order_score<true, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV33::main_order_score<false, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int HeuristicSearcherV33::main_order_score<true, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
HeuristicSearcherV33::ScoredMove HeuristicSearcherV33::make_scored_move(
    const Position& pos,
...
HeuristicSearcherV33::ScoredMove HeuristicSearcherV33::make_tt_lower_scored_move(
    const Position& pos,
    Move move
) const {
    const bool capture = is_capture(move);
...
template <HeuristicSearcherV33::ScoringMode Mode, bool IsCapture, bool IsPromotion>
HeuristicSearcherV33::ScoredMove HeuristicSearcherV33::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::MainSearch, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::MainSearch, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::MainSearch, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::MainSearch, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::Quiescence, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::Quiescence, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::Quiescence, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template HeuristicSearcherV33::ScoredMove
HeuristicSearcherV33::make_scored_legal_move<HeuristicSearcherV33::ScoringMode::Quiescence, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
bool HeuristicSearcherV33::better_scored_move(
...
void HeuristicSearcherV33::sort_scored_moves(ScoredMoveList& moves) const {
...
HeuristicSearcherV33::ScoredMoveList HeuristicSearcherV33::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
HeuristicSearcherV33::CaptureMoveLists
HeuristicSearcherV33::generate_legal_capture_scored_move_lists_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
HeuristicSearcherV33::ScoredMoveList HeuristicSearcherV33::ordered_priority_quiet_moves_for_stage(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
template <HeuristicSearcherV33::MoveGenerationStage Stage>
HeuristicSearcherV33::ScoredMoveList HeuristicSearcherV33::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
template HeuristicSearcherV33::ScoredMoveList
HeuristicSearcherV33::ordered_moves_for_stage<HeuristicSearcherV33::MoveGenerationStage::QuietNonPromotion>(
    const Position&,
