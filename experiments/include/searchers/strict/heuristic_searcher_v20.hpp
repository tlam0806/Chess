...
class HeuristicSearcherV20 final : public Searcher {
public:
...
private:
    ...
    PieceType moved_piece_for(const Position& pos, Move move) const;
    PieceType captured_piece_for(const Position& pos, Move move) const;
