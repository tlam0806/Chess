...
class HeuristicSearcherV23 final : public Searcher {
public:
    struct MoveOrderingWeights {
        int tt_lower_bonus = 633'529'000;
        int tt_upper_bonus = 39'751'000;
        int promotion_bonus = 660'961'000;
        int good_capture_bonus = 63'613'000;
        int bad_capture_bonus = 50'000;
        int see_weight = 17;
        int killer1_bonus = 66'000;
        int killer2_bonus = 40'000;
        int check_bonus = 480'030;
        int counter_history_bonus = 8'000;
        int qsearch_promotion_bonus = 660'961'000;
        int qsearch_good_capture_bonus = 126'279'000;
        int qsearch_bad_capture_bonus = 308'205;
        int qsearch_see_weight = 16;
        int qsearch_captured_value_weight = 415;
    };
