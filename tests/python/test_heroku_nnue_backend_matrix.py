...
from tools.benchmark import run_heroku_nnue_backend_matrix as local_matrix
from tools.benchmark import run_nnue_backend_matrix_remote as remote_matrix
...
class HerokuNnueBackendMatrixTests(unittest.TestCase):
    ...
    @mock.patch("tools.benchmark.run_nnue_backend_matrix_remote.subprocess.run")
