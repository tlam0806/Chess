...
from chess_nnue.compact_board_data import HEADER, pack_record, position_split_bucket
            ...
            for architecture in ("E2", "F2"):
                with self.subTest(architecture=architecture):
                    ...
                    command = [
                        ...
                        "--min-lr", "0.00004",
                        "--lr-schedule", "cosine",
                        "--epoch-peak-lrs", "0.0005", "0.0001",
                        "--epoch-min-lrs", "0.00005", "0.00004",
                        "--lr-steps-per-epoch", "3",
                        "--workers", "2",
                        "--eval-workers", "2",
