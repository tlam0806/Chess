...
void assert_search_returns_legal_move(
    ...
    int depth,
    chess::NnueSearcherV37& searcher
) {
...
int main(int argc, char** argv) {
    if (argc != 2) {
        std::cerr << "usage: nnue_searcher_v37_strict_tests <nnue-model.bin>\n";
        return 2;
    }
    ...
    chess::NnueSearcherV37 searcher(model);
    ...
    std::cout << "nnue strict v37 search returned legal moves\n";
}
