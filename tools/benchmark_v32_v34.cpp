...
int main(int argc, char** argv) {
    ...
    std::uint64_t v34_us = 0;
    std::uint64_t v32_us = 0;
    std::uint64_t v34_nodes = 0;
    ...
    for (std::size_t i = 0; i < positions.size(); ++i) {
        ...
        const Row r34 = run_one(v34, positions[i], depth, iterative);
        const Row r32 = run_one(v32, positions[i], depth, iterative);

        v34_us += r34.us;
        v32_us += r32.us;
        v34_nodes += r34.result.nodes;
        ...
        std::cout << "sample=" << i
                  << " v34_score=" << r34.result.score
                  << " v32_score=" << r32.result.score
                  << " v34_best=" << chess::move_to_string(r34.result.best_move)
    ...
    std::cout << "summary"
              ...
              << " v32_vs_v34_time=" << (v34_us == 0 ? 0.0 : static_cast<double>(v32_us) / v34_us)
