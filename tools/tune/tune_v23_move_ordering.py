...
DEFAULT_WEIGHTS = {
    "history_penalty_num": 3,
    "history_penalty_den": 7,
    "tt_lower_bonus": 765_715_000,
    "tt_upper_bonus": 27_262_000,
    "promotion_bonus": 660_961_000,
    "good_capture_bonus": 63_613_000,
    "bad_capture_bonus": 50_000,
    "see_weight": 25,
    "killer1_bonus": 40_000,
    "killer2_bonus": 40_000,
    "check_bonus": 393_980,
    "counter_history_bonus": 16_000,
    "qsearch_promotion_bonus": 660_961_000,
    "qsearch_good_capture_bonus": 63_613_000,
    "qsearch_bad_capture_bonus": 50_000,
    "qsearch_see_weight": 25,
    "qsearch_captured_value_weight": 0,
}
...
def evaluate(args, candidate, seed):
    ...
    node_ratio = float(summary["v23_vs_v22_nodes"])
    time_ratio = float(summary["v23_vs_v22_time"])
...
def main():
    ...
    parser.add_argument("--benchmark", type=Path, default=Path("build/benchmark_v22_v23"))
    parser.add_argument("--input", type=Path, default=Path("data/tactical_disagreement_depth7_8h_v7_test10k_baseline.jsonl"))
    parser.add_argument("--out", type=Path, default=Path("build/v23_move_order_tune.jsonl"))
