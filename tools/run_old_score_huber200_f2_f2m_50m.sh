...
for required in \
  ...
  tools/convert_f2_to_f2m_checkpoint.py \
  tools/verify_phase_training_checkpoint.py \
  tools/report_f2_f2m_50m.py \
...
.venv/bin/python -m pytest -q \
  tests_py/test_compact_board_data_zstd.py \
  tests_py/test_nnue_horizontal_mirror.py \
  tests_py/test_phase_component_nnue.py \
...
export_and_verify() {
  ...
  local prefix="$4"
  .venv/bin/python tools/verify_phase_training_checkpoint.py \
