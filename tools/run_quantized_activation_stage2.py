...
from tools.run_quantized_scale_grid import hidden_scales_label
...
from nn.quantized_nnue_architectures import QUANTIZED_ARCHITECTURES
...
EVALUATE_SCRIPT = REPO_ROOT / "tools" / "evaluate_quantized_nnue_checkpoint.py"
