...
V45_RUN="${NNUE_V45_TOURNAMENT_SOURCE:-logs/nnue_v45_pareto_broad_12h_20260902_231700}"
...
if [[ ! -e "$RUNNER" ]]; then
  cp tools/match/run_nnue_v45_round_robin.py "$RUNNER"
  cp tools/match/run_nnue_v43_selfplay_race.py "$RUN_DIR/bin/run_nnue_v43_selfplay_race.py"
  chmod +x "$RUNNER"
fi
