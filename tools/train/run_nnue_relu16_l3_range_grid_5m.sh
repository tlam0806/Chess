...
TAG="${TAG:-nnue_relu16_l3_range_grid_5m_$(date +%Y%m%d_%H%M%S)}"
REFERENCE_TAG="${REFERENCE_TAG:-nnue_relu16_hsgrid_exact5m_20260719_012612}"
...
summary_args=(
  --log "reference_hs32x128_os16=logs/${REFERENCE_TAG}_relu16_l2_l3_hs32x128.log"
)
for spec in "64:32" "32:64" "16:128" "8:256"; do
  hs2="${spec%%:*}"
  os="${spec##*:}"
  label="relu16_l2_l3_hs32x${hs2}_os${os}"
...
echo "relu16_l3_range_grid_complete tag=$TAG report=$REPORT"
