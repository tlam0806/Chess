...
from chess_nnue.compact_board_data import compact_paths, validate_compact_dataset
...
PYTHONUNBUFFERED=1 python3 tools/train/train_phase_nnue_until_overfit.py \
  --data "$data_dir" \
