...
int main(int argc, char** argv) {
    ...
    for (std::size_t i = 0; i < positions.size(); ++i) {
        ...
        const Row r30 = run_one(v30, positions[i], depth, iterative);
        ...
        if (r30.result.score != r31.result.score) {
            ++score_mismatches;
        }
        if (r30.result.best_move != r31.result.best_move) {
            ++move_mismatches;
        }
    ...
    std::cout << "summary"
              ...
              << " v30_us=" << v30_us
              << " v31_us=" << v31_us
              << " v30_vs_v31_time=" << (v31_us == 0 ? 0.0 : static_cast<double>(v30_us) / v31_us)
