...
HeuristicSearcherV6::HeuristicSearcherV6(std::size_t tt_mb)
    : tt_(tt_mb) {
}

SearchResult HeuristicSearcherV6::search_best_move(const Position& pos, int depth) {
    SearchContext context;
    return search_fixed_depth(pos, depth, tt_, context);
}

SearchResult HeuristicSearcherV6::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV6::name() const {
    return "heuristic_v6";
}

void HeuristicSearcherV6::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV6::tt_entry_count() const {
