...
HeuristicSearcherV4::HeuristicSearcherV4(std::size_t tt_mb)
    : tt_(tt_mb) {
}

SearchResult HeuristicSearcherV4::search_best_move(const Position& pos, int depth) {
    SearchContext context;
    return search_fixed_depth(pos, depth, tt_, context);
}

SearchResult HeuristicSearcherV4::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV4::name() const {
    return "heuristic_v4";
}

void HeuristicSearcherV4::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV4::tt_entry_count() const {
