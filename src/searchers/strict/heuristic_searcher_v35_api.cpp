...
HeuristicSearcherV35::HeuristicSearcherV35(
    std::size_t tt_mb,
...
std::string_view HeuristicSearcherV35::name() const {
    return "heuristic_v35";
}

void HeuristicSearcherV35::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV35::tt_entry_count() const {
    return tt_.entry_count();
}

void HeuristicSearcherV35::clear_tt_stats() {
    tt_.clear_stats();
}

const RangeTranspositionTableStats& HeuristicSearcherV35::tt_stats() const {
    return tt_.stats();
}
