...
int NnueSearcherV37::qsearch_order_score(
...
template int NnueSearcherV37::qsearch_order_score<false, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV37::qsearch_order_score<true, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV37::qsearch_order_score<false, true>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV37::qsearch_order_score<true, true>(
    PieceType,
    PieceType
) const;

template <bool IsCapture, bool IsPromotion>
NnueSearcherV37::ScoredMove NnueSearcherV37::make_qsearch_scored_move(
    Move move,
    PieceType moved_piece,
    PieceType captured_piece
) const {
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_qsearch_scored_move<false, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_qsearch_scored_move<true, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_qsearch_scored_move<false, true>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_qsearch_scored_move<true, true>(
    Move,
    PieceType,
    PieceType
) const;

bool NnueSearcherV37::is_quiet_move(const ScoredMove& scored_move) const {
...
template <bool IsCapture, bool IsPromotion>
int NnueSearcherV37::main_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
template int NnueSearcherV37::main_order_score<false, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV37::main_order_score<true, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV37::main_order_score<false, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV37::main_order_score<true, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
NnueSearcherV37::ScoredMove NnueSearcherV37::make_scored_move(
    const Position& pos,
...
NnueSearcherV37::ScoredMove NnueSearcherV37::make_tt_lower_scored_move(
    const Position& pos,
    Move move
) const {
    const bool capture = is_capture(move);
...
template <NnueSearcherV37::ScoringMode Mode, bool IsCapture, bool IsPromotion>
NnueSearcherV37::ScoredMove NnueSearcherV37::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::MainSearch, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::MainSearch, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::MainSearch, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::MainSearch, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::Quiescence, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::Quiescence, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::Quiescence, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV37::ScoredMove
NnueSearcherV37::make_scored_legal_move<NnueSearcherV37::ScoringMode::Quiescence, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
bool NnueSearcherV37::better_scored_move(
...
void NnueSearcherV37::sort_scored_moves(ScoredMoveList& moves) const {
...
NnueSearcherV37::ScoredMoveList NnueSearcherV37::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
NnueSearcherV37::CaptureMoveLists
NnueSearcherV37::generate_legal_capture_scored_move_lists_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
NnueSearcherV37::ScoredMoveList NnueSearcherV37::ordered_priority_quiet_moves_for_stage(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
template <NnueSearcherV37::MoveGenerationStage Stage>
NnueSearcherV37::ScoredMoveList NnueSearcherV37::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
template NnueSearcherV37::ScoredMoveList
NnueSearcherV37::ordered_moves_for_stage<NnueSearcherV37::MoveGenerationStage::QuietNonPromotion>(
    const Position&,
