...
int NnueSearcherV44::qsearch_order_score(
...
template int NnueSearcherV44::qsearch_order_score<false, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV44::qsearch_order_score<true, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV44::qsearch_order_score<false, true>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV44::qsearch_order_score<true, true>(
    PieceType,
    PieceType
) const;

template <bool IsCapture, bool IsPromotion>
NnueSearcherV44::ScoredMove NnueSearcherV44::make_qsearch_scored_move(
    Move move,
    PieceType moved_piece,
    PieceType captured_piece
) const {
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_qsearch_scored_move<false, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_qsearch_scored_move<true, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_qsearch_scored_move<false, true>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_qsearch_scored_move<true, true>(
    Move,
    PieceType,
    PieceType
) const;

bool NnueSearcherV44::is_quiet_move(const ScoredMove& scored_move) const {
...
template <bool IsCapture, bool IsPromotion>
int NnueSearcherV44::main_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
template int NnueSearcherV44::main_order_score<false, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV44::main_order_score<true, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV44::main_order_score<false, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV44::main_order_score<true, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
NnueSearcherV44::ScoredMove NnueSearcherV44::make_scored_move(
    const Position& pos,
...
NnueSearcherV44::ScoredMove NnueSearcherV44::make_tt_lower_scored_move(
    const Position& pos,
    Move move
) const {
    const bool capture = is_capture(move);
...
template <NnueSearcherV44::ScoringMode Mode, bool IsCapture, bool IsPromotion>
NnueSearcherV44::ScoredMove NnueSearcherV44::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::MainSearch, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::MainSearch, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::MainSearch, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::MainSearch, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::Quiescence, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::Quiescence, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::Quiescence, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV44::ScoredMove
NnueSearcherV44::make_scored_legal_move<NnueSearcherV44::ScoringMode::Quiescence, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
bool NnueSearcherV44::better_scored_move(
...
void NnueSearcherV44::sort_scored_moves(ScoredMoveList& moves) const {
...
NnueSearcherV44::ScoredMoveList NnueSearcherV44::ordered_moves(
    const Position& pos,
    int ply,
    MoveHints tt_moves,
    Move prev_move,
...
NnueSearcherV44::CaptureMoveLists
NnueSearcherV44::generate_legal_capture_scored_move_lists_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveHints tt_moves,
...
NnueSearcherV44::ScoredMoveList NnueSearcherV44::ordered_priority_quiet_moves_for_stage(
    const Position& pos,
    int ply,
    MoveHints tt_moves,
    Move prev_move,
...
template <NnueSearcherV44::MoveGenerationStage Stage>
NnueSearcherV44::ScoredMoveList NnueSearcherV44::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveHints tt_moves,
...
template NnueSearcherV44::ScoredMoveList
NnueSearcherV44::ordered_moves_for_stage<NnueSearcherV44::MoveGenerationStage::QuietNonPromotion>(
    const Position&,
