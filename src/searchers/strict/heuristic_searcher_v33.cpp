...
void HeuristicSearcherV33::reward_quiet_cutoff(
    Color side_to_move,
    int depth,
    int ply,
...
void HeuristicSearcherV33::penalize_failed_quiets(
    Color side_to_move,
    int depth,
    Move prev_move,
    PieceType prev_moved_piece,
    const HeuristicSearcherV33::ScoredMoveList& failed_quiet_moves
) {
...
bool HeuristicSearcherV33::should_stop(SearchState& state) const {
...
KingSafetyContext HeuristicSearcherV33::current_king_safety_context(const Position& pos) const {
    return cached_king_safety_context(pos, pos.side_to_move);
}

int HeuristicSearcherV33::evaluate_current_position(const Position& pos) const {
    return evaluate_for_side_to_move(pos);
}



HeuristicSearcherV33::SearchValue HeuristicSearcherV33::quiescence(
    Position& pos,
    int alpha,
    int beta,
    int ply,
...
HeuristicSearcherV33::SearchValue HeuristicSearcherV33::negamax(
    Position& pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV33::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
HeuristicSearcherV33::RootSearchResult HeuristicSearcherV33::search_fixed_depth(
    Position pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV33::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
SearchResult HeuristicSearcherV33::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
...
SearchResult HeuristicSearcherV33::search_best_move(const Position& pos, const SearchLimits& limits) {
