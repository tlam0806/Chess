...
int NnueSearcherV38::qsearch_order_score(
...
template int NnueSearcherV38::qsearch_order_score<false, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV38::qsearch_order_score<true, false>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV38::qsearch_order_score<false, true>(
    PieceType,
    PieceType
) const;

template int NnueSearcherV38::qsearch_order_score<true, true>(
    PieceType,
    PieceType
) const;

template <bool IsCapture, bool IsPromotion>
NnueSearcherV38::ScoredMove NnueSearcherV38::make_qsearch_scored_move(
    Move move,
    PieceType moved_piece,
    PieceType captured_piece
) const {
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_qsearch_scored_move<false, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_qsearch_scored_move<true, false>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_qsearch_scored_move<false, true>(
    Move,
    PieceType,
    PieceType
) const;
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_qsearch_scored_move<true, true>(
    Move,
    PieceType,
    PieceType
) const;

bool NnueSearcherV38::is_quiet_move(const ScoredMove& scored_move) const {
...
template <bool IsCapture, bool IsPromotion>
int NnueSearcherV38::main_order_score(
    Move move,
    const Position& pos,
    PieceType moved_piece,
    int ply,
...
template int NnueSearcherV38::main_order_score<false, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV38::main_order_score<true, false>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV38::main_order_score<false, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
template int NnueSearcherV38::main_order_score<true, true>(
    Move,
    const Position&,
    PieceType,
    int,
...
NnueSearcherV38::ScoredMove NnueSearcherV38::make_scored_move(
    const Position& pos,
...
NnueSearcherV38::ScoredMove NnueSearcherV38::make_tt_lower_scored_move(
    const Position& pos,
    Move move
) const {
    const bool capture = is_capture(move);
...
template <NnueSearcherV38::ScoringMode Mode, bool IsCapture, bool IsPromotion>
NnueSearcherV38::ScoredMove NnueSearcherV38::make_scored_legal_move(
    const Position& pos,
    Move move,
    PieceType moved_piece,
    PieceType captured_piece,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::MainSearch, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::MainSearch, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::MainSearch, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::MainSearch, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::Quiescence, false, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::Quiescence, true, false>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::Quiescence, false, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
template NnueSearcherV38::ScoredMove
NnueSearcherV38::make_scored_legal_move<NnueSearcherV38::ScoringMode::Quiescence, true, true>(
    const Position&,
    Move,
    PieceType,
    PieceType,
...
bool NnueSearcherV38::better_scored_move(
...
void NnueSearcherV38::sort_scored_moves(ScoredMoveList& moves) const {
...
NnueSearcherV38::ScoredMoveList NnueSearcherV38::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
NnueSearcherV38::CaptureMoveLists
NnueSearcherV38::generate_legal_capture_scored_move_lists_for_searcher(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
NnueSearcherV38::ScoredMoveList NnueSearcherV38::ordered_priority_quiet_moves_for_stage(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
template <NnueSearcherV38::MoveGenerationStage Stage>
NnueSearcherV38::ScoredMoveList NnueSearcherV38::ordered_moves_for_stage(
    const Position& pos,
    const KingSafetyContext& king_safety,
    int ply,
    MoveRange tt_moves,
...
template NnueSearcherV38::ScoredMoveList
NnueSearcherV38::ordered_moves_for_stage<NnueSearcherV38::MoveGenerationStage::QuietNonPromotion>(
    const Position&,
