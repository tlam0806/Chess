...
struct HeuristicSearcherV22::SearchState {
...
enum class HeuristicSearcherV22::ScoringMode {
    MainSearch,
    Quiescence
};

struct HeuristicSearcherV22::SearchValue {
    ScoreRange range{};
};

struct HeuristicSearcherV22::TTProbeResult {
    ScoreRange range{};
    MoveRange moves{};
    bool hit = false;
...
int HeuristicSearcherV22::score_to_tt(int score, int ply) const {
...
HeuristicSearcherV22::TTProbeResult HeuristicSearcherV22::probe_tt(
    HashKey key,
    int depth,
    int& alpha,
    int& beta,
...
bool HeuristicSearcherV22::should_store_tt(ScoreRange range) const {
    return EnableTt
        && (range.lower != range.upper || EnableTtExactStore);
}

bool HeuristicSearcherV22::should_stop(SearchState& state) const {
...
int HeuristicSearcherV22::move_order_score(
    Move move,
    const Position& pos,
...
HeuristicSearcherV22::ScoredMove HeuristicSearcherV22::make_scored_move(
    const Position& pos,
...
bool HeuristicSearcherV22::better_scored_move(
...
void HeuristicSearcherV22::sort_scored_moves(std::vector<ScoredMove>& moves) const {
...
std::vector<HeuristicSearcherV22::ScoredMove> HeuristicSearcherV22::ordered_moves(
    const Position& pos,
    int ply,
    MoveRange tt_moves,
    Move prev_move,
...
HeuristicSearcherV22::SearchValue HeuristicSearcherV22::quiescence(
    Position pos,
    int alpha,
    int beta,
    int ply,
...
bool HeuristicSearcherV22::is_quiet_move(const ScoredMove& scored_move) const {
    return !scored_move.capture
        && !scored_move.promotion
        && !scored_move.gives_check;
}

void HeuristicSearcherV22::add_move_type_stats(
    MoveTypeStats& stats,
...
void HeuristicSearcherV22::record_node_with_moves(ScoringMode stage) {
...
void HeuristicSearcherV22::record_beta_cutoff(
...
HeuristicSearcherV22::SearchValue HeuristicSearcherV22::negamax(
    Position pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV22::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
SearchResult HeuristicSearcherV22::search_fixed_depth(
    const Position& pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV22::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
HeuristicSearcherV22::HeuristicSearcherV22(
    std::size_t tt_mb,
...
SearchResult HeuristicSearcherV22::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
    SearchState state;
    return search_fixed_depth(pos, depth, state);
}

SearchResult HeuristicSearcherV22::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV22::name() const {
    return "heuristic_v22";
}

void HeuristicSearcherV22::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV22::tt_entry_count() const {
    return tt_.entry_count();
}

void HeuristicSearcherV22::clear_tt_stats() {
    tt_.clear_stats();
}

const RangeTranspositionTableStats& HeuristicSearcherV22::tt_stats() const {
    return tt_.stats();
}

void HeuristicSearcherV22::clear_move_ordering_stats() {
    move_ordering_stats_ = MoveOrderingStats{};
}

const HeuristicSearcherV22::MoveOrderingStats& HeuristicSearcherV22::move_ordering_stats() const {
    return move_ordering_stats_;
}

void HeuristicSearcherV22::set_move_ordering_stats_enabled(bool enabled) {
