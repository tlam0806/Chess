...
void HeuristicSearcherV35::penalize_failed_quiets(
    Color side_to_move,
    int depth,
    Move prev_move,
    PieceType prev_moved_piece,
    const HeuristicSearcherV35::ScoredMoveList& failed_quiet_moves
) {
...
bool HeuristicSearcherV35::should_stop(SearchState& state) const {
...
KingSafetyContext HeuristicSearcherV35::current_king_safety_context(const Position& pos) const {
    return cached_king_safety_context(pos, pos.side_to_move);
}

int HeuristicSearcherV35::evaluate_current_position(const Position& pos) const {
    return evaluate_for_side_to_move(pos);
}



HeuristicSearcherV35::SearchValue HeuristicSearcherV35::quiescence(
    Position& pos,
    int alpha,
    int beta,
    int ply,
...
HeuristicSearcherV35::SearchValue HeuristicSearcherV35::negamax(
    Position& pos,
    int depth,
    int ply,
    Move prev_move,
...
SearchResult HeuristicSearcherV35::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
HeuristicSearcherV35::RootSearchResult HeuristicSearcherV35::search_fixed_depth(
    Position pos,
    int depth,
    SearchState& state,
    int alpha,
...
SearchResult HeuristicSearcherV35::search_root_without_tt_probe(
    const Position& pos,
    int depth,
    SearchState& state
) {
...
SearchResult HeuristicSearcherV35::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
