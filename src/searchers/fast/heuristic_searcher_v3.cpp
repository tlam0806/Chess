...
HeuristicSearcherV3::HeuristicSearcherV3(std::size_t tt_mb)
    : tt_(tt_mb) {
}

SearchResult HeuristicSearcherV3::search_best_move(const Position& pos, int depth) {
    SearchContext context;
    return search_fixed_depth(pos, depth, tt_, context);
}

SearchResult HeuristicSearcherV3::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV3::name() const {
    return "heuristic_v3";
}

void HeuristicSearcherV3::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV3::tt_entry_count() const {
