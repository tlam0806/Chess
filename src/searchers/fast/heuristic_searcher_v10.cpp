...
void HeuristicSearcherV10::make_null_move(Position& pos) const {
...
bool HeuristicSearcherV10::should_stop(SearchContext& context) const {
...
HeuristicSearcherV10::MoveOrderStage HeuristicSearcherV10::move_order_stage(
    Move move,
    Move tt_move,
    int ply,
    bool gives_check,
...
int HeuristicSearcherV10::move_tie_break_score(
    Move move,
    const Position& pos,
    int ply,
    bool gives_check,
...
HeuristicSearcherV10::ScoredMove HeuristicSearcherV10::make_scored_move(
    const Position& pos,
    Move move,
    int ply,
    Move tt_move,
...
bool HeuristicSearcherV10::better_scored_move(
...
int HeuristicSearcherV10::stage_rank(MoveOrderStage stage) const {
    switch (profile_) {
...
std::vector<HeuristicSearcherV10::ScoredMove> HeuristicSearcherV10::ordered_moves(
    const Position& pos,
    int ply,
    Move tt_move
) const {
...
std::vector<HeuristicSearcherV10::ScoredMove> HeuristicSearcherV10::ordered_noisy_moves(
    const Position& pos
) const {
    std::vector<ScoredMove> ordered;
    const std::vector<Move> moves = generate_legal_moves(pos);
...
bool HeuristicSearcherV10::should_reduce_late_move(
    const Position& pos,
...
bool HeuristicSearcherV10::can_null_move_prune(
    const Position& pos,
    int depth,
...
int HeuristicSearcherV10::quiescence(
    Position pos,
    int alpha,
    int beta,
    int ply,
...
bool HeuristicSearcherV10::is_quiet_move(const ScoredMove& scored_move) const {
    return !scored_move.capture
        && !scored_move.promotion
        && !scored_move.gives_check;
}

int HeuristicSearcherV10::negamax(
    Position pos,
    int depth,
    int ply,
    int alpha,
...
SearchResult HeuristicSearcherV10::make_fallback_result(const Position& pos) const {
    SearchResult result;
...
SearchResult HeuristicSearcherV10::search_fixed_depth(
    const Position& pos,
    int depth,
    SearchContext& context
) {
...
HeuristicSearcherV10::HeuristicSearcherV10(
    std::size_t tt_mb,
...
SearchResult HeuristicSearcherV10::search_best_move(const Position& pos, int depth) {
    killer_table_.clear();
    SearchContext context;
    return search_fixed_depth(pos, depth, context);
}

SearchResult HeuristicSearcherV10::search_best_move(const Position& pos, const SearchLimits& limits) {
...
std::string_view HeuristicSearcherV10::name() const {
    return "heuristic_v10";
}

void HeuristicSearcherV10::clear_tt() {
    tt_.clear();
}

std::size_t HeuristicSearcherV10::tt_entry_count() const {
    return tt_.entry_count();
}

void HeuristicSearcherV10::clear_tt_stats() {
    tt_.clear_stats();
}

const TranspositionTableStats& HeuristicSearcherV10::tt_stats() const {
    return tt_.stats();
}
