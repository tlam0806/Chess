...
| M03 | 2026-06-19 to 2026-07-09 | Classical V20-V35 search and TT experiments | Historical baseline | Reconstructed with caveats | A clean 2026-08-25 V32/V35 diagnostic reproduced identical search trees on 26 positions, but the fixed-order timing is not a promotion-quality speed test. |
...
| M03 | `c68faa8` strict-search optimization through `d08810d` V35 variants |
...
|---|---|---|
| Core rules/move generation | 64 of 69 clean-snapshot CTests passed; all current V36-V41 tests passed | Fix or explicitly retire three historical V21-V23 warm/cold assertions. Two legacy NN tests require ignored model/data assets and are not clean-clone tests. |
